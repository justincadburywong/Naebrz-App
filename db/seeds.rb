...
50.times do (
	Event.create(event_name: Faker::Company.catch_phrase, location: Faker::Address.street_address, start_time: Faker::Time.forward(rand(1..5), :morning), end_time: Faker::Time.forward(rand(6..9), :evening), host_id: rand(1..20)))
	end