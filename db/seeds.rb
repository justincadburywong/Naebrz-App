...
50.times do (
	Event.create(event_name: Faker::Company.catch_phrase, street: Faker::Address.street_address, city: Faker::Address.city, state: Faker::Address.state, postcode: Faker::Address.postcode, start_time: Faker::Time.forward(rand(1..5), :morning), end_time: Faker::Time.forward(rand(6..9), :evening), host_id: rand(1..20)))
	end